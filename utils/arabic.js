...
const arabic = {
    ...
    features: [
...

      {
        ...
        bullets: [
          ...
          "توفير يصل إلى 100٪ على فواتير الكهرباء",
          "توفير يصل إلى 50٪ على فواتير المياه",
          "رسوم خدمات تصل إلى الصفر",
        ],
  ...
  commontext: {
    ...
    comparison: "مقارنة",
    dontforget: "لا تنسى",
    othervillatypes: "أنواع الفيلات الأخرى",
    viewin: "عرض في",
    masterplan: "خريطة المشروع",
    nearby: "المناطق المجاورة",
    amenities: "الخدمات",
    interiorHeading: "المكونات الداخلية",
    caption: "الوصف",
    registerinterest: "سجل اهتمامك",
    findyour: "اكتشف",
    dreamHome: "منزلك المثالي",
    ...
    post: [
      {
        ...
        title: [
          "المدينة المستدامة - يتي و صحار الإسلامي يوقعان ",
          "اتفاقية تفعيل حسابات الضمان العقاري ",
        ],
        date: " ٢٩ يونيو ٢٠٢٢    ",
        city: "مسقط",
        country: "سلطنة عمان ",
        ...
        type: "news",
        source: "https://www.thesustainablecity-yiti.com/ar/news/",
        heading:
      ...
      },
      {
        ...
        discription: [
          "الاتفاقية الجديدة ستعزز التزام الشراكة نحو بناء مجتمعات مستدامة حيادية الكربون",
          "دبي، ١٣ يناير ٢٠٢٢: أبرمت دايموند للتطوير العقاري المتخصصة في تطوير المشروعات البيئية بدبي اتفاقية شراكة تطويرية مع الشركة العمانية للتنمية السياحية (مجموعة عُمران) لتنفيذ المرحلة الأولى من مشروع يتي السياحي المتكامل بقيمة استثمارية تبلغ نحو 3.7 مليار درهم إماراتي (تبلغ قرابة مليار دولار أمريكي). وقد أثمرت هذه الشراكة تأسيس شركة التطوير والاستثمار المستدام ش.م.ع.م لتتولى مهام تنفيذ هذه المرحلة من المشروع.",
          "وستركز المرحلة الأولى من المشروع التي سُتنفذ على مساحة تصل إلى 900,000 مترًا مربعًا على إنشاء مشروع سياحي مستدام متعدد الاستخدامات، كما يحتفي المشروع الأول من نوعه في السلطنة بأنماط الحياة المستدامة. وستضم هذه المرحلة مجموعة من المرافق الرئيسية كالمتنزهات والمرافق العامة والوحدات السكنية والمحلات التجارية والمرافق التعليمية. وسيتسنى للزوار والقاطنين في المدينة التمتع بمجموعة واسعة من الخيارات والتجارب تتضمن مرافق للضيافة، والمطاعم والمقاهي ومركزاً للفروسية. ومن المؤمل أن يتم إطلاقه رسمياً والكشف عن كافة تفاصيله في وقت قريب لاحق.",
          "وحول أهمية هذه الشراكة التطويرية، قال هاشل بن عبيد المحروقي، الرئيس التنفيذي لمجموعة عُمران: يشكل تعاون مجموعة عُمران مع دايموند للتطوير العقاري لتنفيذ المرحلة الأولى من مشروع يتي السياحي المتكامل انطلاقة فارقة نستهل من خلالها العمل على بلورة الأهداف الموضوعة من خلال تنفيذ جزء حيوي من المخطط الرئيسي لهذا المشروع. كما يعكس توقيع هذه الاتفاقية رؤية المجموعة واستراتيجيتها الرامية إلى دفع عجلة التنمية السياحية في السلطنة من خلال جذب الاستثمار الأجنبي المباشر بما يتوافق مع توجهات جهاز الاستثمار العماني وأهداف رؤية عُمان 2040 والاستراتيجية الوطنية للسياحة في دعم الاقتصاد الوطني. ",
          "وأضاف المحروقي: يسرنا التعاون مع شركة دايموند للتطوير العقاري باعتبارها إحدى الشركات التي وضعت بصمتها جليًا في إنشاء المدن المستدامة في المنطقة، بما ينسجم مع منهجيتنا الراسخة في تطبيق أسس صناعة المكان وتأصيل الاستدامة في نمط الحياة وعبر جميع مكونات المشروع.",
          "من جانبه، قال المهندس فارس سعيد، رئيس مجلس إدارة  دايموند للتطوير العقاري: نحن سعداء للغاية بالشراكة مع مجموعة عُمران لتنفيذ أول مشروعاتنا على أرض السلطنة التي تزخر بمقومات وموارد طبيعية غنية، ونتطلع إلى إطلاق المرحلة الأولى من هذا المشروع الحيوي الذي سيرسي معايير جديدة يتجسد فيها التناغم التام بين الثراء الطبيعي ونمط الحياة العصرية وفق أعلى معايير الاستدامة، حيث تمتلك شركة دايموند للتطوير العقاري خبرة عميقة في بناء المدن المستدامة مكنتها من تحقيق إنجازات متميزة يُحتذى بها في المنطقة. ونتطلع بكل شغف إلى توظيف خبراتنا المتراكمة وشراكتنا مع نخبة من المؤسسات الأكاديمية والبحثية العالمية في إرساء معايير جديدة لبناء مدن المستقبل المستدامة والوصول لمستقبل حيادي الكربون.",
      ...
      },
      {
        ...
        title: [
          "بقيمة استثمارية تبلغ مليار دولاراً أمريكياً دايموند ديفيلوبرز ومجموعة ",
          "عُمران تعلنان عن إطلاق المدينة المستدامة في يتي",
        ],
        date: "٣٠ مارس ٢٠٢٢",
        city: "دبي",
        country: "الإمارات العربية المتحدة",
        ...
        discription: [
          ...
          "•	سيحقق المشروع الحياد الكربوني بحلول العام ٢٠٤٠  ",
          "٣٠ مارس ٢٠٢٢: تحتفل اليوم شركة دايموند ديفيلوبرز - المتخصصة في تطوير المدن المستدامة – وبالشراكة مع الشركة العُمانية للتنمية السياحية (مجموعة عُمران) عن إطلاق مشروع المدينة المستدامة - يتي في مسقط، بتكلفة إجمالية تبلغ قرابة مليار دولار، والذي يمثل أول مشروع يلبي أعلى معايير الاستدامة والاقتصاد الأخضر في سلطنة عُمان.",
          ,
          "وتمثل المدينة المستدامة - يتي التي سيجري تطويرها ضمن المرحلة الأولى في المخطط العام لمشروع يتي السياحي المتكامل - أول مشروع يلبي أعلى معايير الاستدامة والاقتصاد الأخضر في السلطنة على مساحة إجمالية تصل إلى مليون متراً مربعاً. ويتميز بموقعه الفريد في ولاية مسقط وبإطلالته على بحر عُمان ومقوماته الطبيعية الثرية، من الشطآن الممتدة والجبال والمنحدرات الصخرية، فضلاً عن الأودية التي تتناغم ضمن طبوغرافية الموقع، ما يضفي قيمة تنافسية جديرة بالاهتمام للمشروع. ",
          "وحول ذلك، قال فارس سعيد، رئيس مجلس إدارة شركة دايموند ديفيلوبرز للتطوير العقاري: لا تقتصر أهمية هذا المشروع على كونه نموذجاً يحتذى به للتطوير العُمراني المستدام، بل إنه يُعد ايضاً مجتمعاً متكاملاً يضم مرافق سكنية وخدمية مختلفة، ويحتضن الآلاف من المقيمين، والزوار، والطلبة، والباحثين.",
          "وأضاف ستكون المدينة المستدامة – يتي من بين أكثر المشاريع استدامة على مستوى المنطقة، ونسعى من خلال توظيف أحدث الحلول في إنتاج الطاقة، وإعادة التدوير، وإنتاج الماء من الهواء، والزراعة العمودية، والنقل ذاتي القيادة وغيرها إلى تحقيق الحياد الكربوني بحلول العام ٢٠٤٠، بما يتوافق مع أهداف التنمية المستدامة واتفاقية باريس للمناخ، ونتطلع في دايموند ديفيلوبرز إلى المضي قدماً في دعم جهود الحفاظ على البيئة وتعزيز التنمية المستدامة في المنطقة وأن نُسهم في الانتقال الفاعل نحو اقتصاد منخفض الكربون.",
          "ومن جانبه قال المهندس محمد بن سالم البوسعيدي، رئيس مجلس مجموعة عُمران: يعد التعاون مع دايموند ديفيلوبرز لإطلاق المدينة المستدامة - يتي علامة فارقة في رحلتنا نحو تحفيز الاستثمار وتطوير إمكانات القطاع السياحي في السلطنة، حيث يعتبر ضمن أكبر مشروعات التطوير الحضري التي يجري تطويرها في منطقة الشرق الأوسط، الأمر الذي يؤهله لفتح آفاق واعدة لجذب الاستثمارات المحلية والأجنبية وذلك موائمةً مع توجهات جهاز الاستثمار العُماني. وتماشيا مع جهود السلطنة نحو التحول إلى الاقتصاد الدائري الأخضر وخفض الانبعاثات الكربونية، فإن المشروع يلبي أعلى معايير الاستدامة ويجسد رؤيتنا المتمثلة في صناعة وجهات تتناغم بشكل تام مع الثراء الطبيعي وفق أعلى درجات الحفاظ على البيئة.",
          "ومن المخطط أن ينتهي إنجاز المشروع بحلول عام ٢٠٢٥، وسيوفر ١٦٥٧ وحدة سكنية، تتضمن ٣٠٠ فيلا صديقة للبيئة بتصاميم عصرية وعالية الكفاءة ومساحات متنوعة للفلل المؤلفة من ٣ و٤ غرف نوم، كما يتيح فرص توفير كبيرة للسكان في فواتير التشغيل والخدمات.",
          "وتماشيا مع أهداف الأمم المتحدة للتنمية المستدامة نحو تقليل الاعتماد على مصادر الطاقة غير النظيفة، ستعتمد المدينة على مصادر الطاقة المتجددة بالكامل لتشغيل كافة مرافقها، حيث تنتج ١٠٠٪ من طاقتها في المرحلة التشغيلية عبر الألواح الشمسية والغاز الحيوي كما تقوم بإعادة تدوير المياه والنفايات العضوية بنسبة ١٠٠٪ إضافة إلى إعادة استعمال المياه المعاد تدويرها لري المناطق الزراعية والمساحات الخضراء، بالإضافة لتوفير مساحات زراعية خاصة للسكان.",
          "وتعمل المدينة على تقليل انبعاثاتها الكربونية من خلال تطبيق أفضل الممارسات البيئية مثل الاعتماد على المركبات الكهربائية، والعربات ذاتية القيادة للتنقل داخل المدينة، وتوفير محطات شحن السيارات الكهربائية، كما تتميز المناطق السكنية بخلوها من السيارات مما يوفر بيئة آمنة للعائلات ويشجع على خلق علاقات اجتماعية متينة بين السكان.",
          "كما يشمل المشروع مدرسة تعتمد غرس مفاهيم الاستدامة في مناهجها للجيل القادم، بالإضافة إلى مختبر (سي) الذي يعرض أبرز حلول الاستدامة كتقنيات الطاقة المتجددة والزراعة العمودية وغيرها من الحلول البيئية علاوة على زيادة الوعي البيئي وتسريع بناء مدن المستقبل.",
          "وتهدف المدينة المستدامة أيضا إلى تعزيز نمط الحياة الصحية، حيث تحتوي على مراكز صحية ورياضية ومرافق للركض وركوب الدراجات ونادي للفروسية ومضمار للخيل، بالإضافة إلى مجموعة من المحلات التجارية والمطاعم، والمقاهي، والمراكز الفنية، والثقافية.",
          "ولدعم قطاع الضيافة تحتضن المدينة منتجع من فئة الخمس نجوم يحتوي على ١٧٠ غرفة بالإضافة إلى ١٣٢ شقة فندقية فاخرة، وفندق من فئة الأربع نجوم يحتوي على ١٩٧ غرفة، توفر هذه الفنادق أعلى مستويات الخدمة والرفاهية بالإضافة لإمكانية الوصول إلى الشاطئ والاستمتاع بمختلف النشاطات البحرية.",
        ],
      },
      {
  ...
  seo: {
    home: {
      ...
      description:
        "ستكون المدينة المستدامة يتي أكبر مجتمع مستدام في العالم ، مع طموح أن تكون أول مجتمع صافي الانبعاثات الصفرية في عمان بحلول عام 2040.", // add the words which users could search 150-160 character max
    ...
    floorplan: {
      title: "فلل الحي المستدام | المدينة المستدامة يتي", // 50-50 characters only
      description:
        "ابحث عن منزل أحلامك في المدينة المستدامة يتي واحصل على تجربة المعيشة المستدامة مع صفر رسوم الخدمات وفواتير كهرباء وماء مخفضة!",
      keyword: [
        "يتي",
        "المدينة المستدامة",
        "مسقط",
    ...
    "courtyard-villa-3bedroom": {
      title: "فيلا كورتيارد ٣ غرف نوم | المدينة المستدامة يتي", // 50-50 characters only
      description:
        "مصممة لتخفيض فاتورة الكهرباء بنسبة تصل إلى 100٪ ، تحقق من فلل كورتيارد المكونة من 3 غرف نوم في المنطقة الغربية المستدامة",
      keyword: [
        "يتي",
        "المدينة المستدامة",
        "مسقط",
      ...
      og: {
        img: "https://thesustainablecity-yiti.com/Images/masterplanimage.png",
        title: "فيلا كورتيارد ٣ غرف نوم | المدينة المستدامة يتي", // 50-50 characters only
        url: "https://thesustainablecity-yiti.com/ar/floorplan/courtyard-villa-3bedroom",
        description:
          "مصممة لتخفيض فاتورة الكهرباء بنسبة تصل إلى 100٪ ، تحقق من فلل كورتيارد المكونة من 3 غرف نوم في المنطقة الغربية المستدامة",
      },
      canonicaltag:
        "https://www.thesustainablecity-yiti.com/ar/floorplan/courtyard-villa-3bedroom",
    },
    "courtyard-villa-4bedroom": {
      title: "فيلا كورتيارد ٤ غرف نوم | المدينة المستدامة يتي", // 50-50 characters only
      description:
        "مصممة لتخفيض فاتورة الكهرباء بنسبة تصل إلى 100٪ ، تحقق من فلل كورتيارد المكونة من 4 غرف نوم في المنطقة الغربية المستدامة",
      keyword: [
        "يتي",
        "المدينة المستدامة",
        "مسقط",
      ...
      og: {
        img: "https://thesustainablecity-yiti.com/Images/masterplanimage.png",
        title: "فيلا كورتيارد ٤ غرف نوم | المدينة المستدامة يتي",
        url: "https://thesustainablecity-yiti.com/ar/floorplan/courtyard-villa-4bedroom",
        description:
          "مصممة لتخفيض فاتورة الكهرباء بنسبة تصل إلى 100٪ ، تحقق من فلل كورتيارد المكونة من 4 غرف نوم في المنطقة الغربية المستدامة",
      },
      canonicaltag:
        "https://www.thesustainablecity-yiti.com/ar/floorplan/courtyard-villa-4bedroom",
    },
    "garden-villa-4bedroom": {
      title: "فيلا حديقة ٤ غرف نوم | المدينة المستدامة يتي", // 50-50 characters only
      description:
        "مصممة لتخفيض فاتورة الكهرباء بنسبة تصل إلى 100٪ ، تحقق من فلل الحديقة المكونة من 4 غرف نوم في منطقة الشرق المستدامة",
      keyword: [
        "يتي",
        "المدينة المستدامة",
        "مسقط",
      ...
      og: {
        img: "https://thesustainablecity-yiti.com/Images/masterplanimage.png",
        title: "فيلا حديقة ٤ غرف نوم | المدينة المستدامة يتي",
        url: "https://thesustainablecity-yiti.com/ar/floorplan/garden-villa-4bedroom",
        description:
          "مصممة لتخفيض فاتورة الكهرباء بنسبة تصل إلى 100٪ ، تحقق من فلل الحديقة المكونة من 4 غرف نوم في منطقة الشرق المستدامة",
      },
      canonicaltag:
        "https://www.thesustainablecity-yiti.com/ar/floorplan/garden-villa-4bedroom",
    },
    aboutus: {
      title: "من نحن | المدينة المستدامة يتي", // 50-50 characters only
      description:
        "تضافرت جهود دايموند ديفلوبرز وعمران لتطوير مشروع عالمي المستوى يلبي أعلى معايير الاستدامة الاجتماعية والبيئية والاقتصادية.",
      keyword: [
        "يتي",
        "المدينة المستدامة",
        "مسقط",
      ...
      og: {
        img: "https://thesustainablecity-yiti.com/Images/masterplanimage.png",
        title: "من نحن | المدينة المستدامة يتي", // 50-50 characters only
        url: "https://thesustainablecity-yiti.com/ar/about",
        description:
          "تضافرت جهود دايموند ديفلوبرز وعمران لتطوير مشروع عالمي المستوى يلبي أعلى معايير الاستدامة الاجتماعية والبيئية والاقتصادية.",
      },
    ...
    contactus: {
      ...
      description: "سجل اهتمامك في المدينة المستدامة يتي الآن!",
      keyword: [
        "يتي",
        "المدينة المستدامة",
        "مسقط",
      ...
      og: {
        img: "https://thesustainablecity-yiti.com/Images/masterplanimage.png",
        url: "https://thesustainablecity-yiti.com/ar/contact-us",
        title: "تواصل معنا | المدينة المستدامة يتي", // 50-50 characters only
        description: "سجل اهتمامك في المدينة المستدامة يتي الآن!",
      },
    ...
    newspage: {
      title: "الصحافة | المدينة المستدامة يتي", // 50-50 characters only
      description: "آخر الأخبار وتحديثات المشروع ",
      keyword: [
        "يتي",
        "المدينة المستدامة",
        "مسقط",
    ...
    newsdetails: {
      "newly-launched-plan": {
        title:
          "المدينة المستدامة - يتي و صحار الإسلامي يوقعان اتفاقية تفعيل حسابات الضمان العقاري | المدينة المستدامة يتي",
        description:
          "المدينة المستدامة - يتي و صحار الإسلامي يوقعان اتفاقية تفعيل حسابات الضمان العقاري",
        keyword: [
          "يتي",
          "المدينة المستدامة",
          "مسقط",
        ...
        og: {
          ...
          title:
            "المدينة المستدامة - يتي و صحار الإسلامي يوقعان اتفاقية تفعيل حسابات الضمان العقاري | المدينة المستدامة يتي",
          url: "https://thesustainablecity-yiti.com/ar/news/newly-launched-plan",
          description:
            "المدينة المستدامة - يتي و صحار الإسلامي يوقعان اتفاقية تفعيل حسابات الضمان العقاري",
        },
        canonicaltag:
          "https://www.thesustainablecity-yiti.com/ar/news/newly-launched-plan",
      },
      "tourism-partnership-omran": {
        title:
          "دايموند للتطوير العقاري توقع اتفاقية شراكة مع الشركة العمانية للتنمية السياحية (عُمران) | المدينة المستدامة يتي",
        description:
          "دايموند للتطوير العقاري توقع اتفاقية شراكة مع الشركة العمانية للتنمية السياحية (عُمران)",
        keyword: [
          "يتي",
          "المدينة المستدامة",
          "مسقط",
        ...
        og: {
          ...
          title:
            "دايموند للتطوير العقاري توقع اتفاقية شراكة مع الشركة العمانية للتنمية السياحية (عُمران) | المدينة المستدامة يتي",
          url: "https://thesustainablecity-yiti.com/ar/news/tourism-partnership-omran",
          description:
            "دايموند للتطوير العقاري توقع اتفاقية شراكة مع الشركة العمانية للتنمية السياحية (عُمران)",
        },
        canonicaltag:
          "https://www.thesustainablecity-yiti.com/ar/news/tourism-partnership-omran",
      },
      "investment-value-news": {
        title:
          "بقيمة استثمارية تبلغ مليار دولاراً أمريكياً دايموند ديفيلوبرز ومجموعة عُمران تعلنان عن إطلاق المدينة المستدامة في يتي | المدينة المستدامة يتي",
        description:
          "بقيمة استثمارية تبلغ مليار دولاراً أمريكياً دايموند ديفيلوبرز ومجموعة عُمران تعلنان عن إطلاق المدينة المستدامة في يتي",
        keyword: [
          "يتي",
          "المدينة المستدامة",
          "مسقط",
        ...
        og: {
          ...
          title:
            "بقيمة استثمارية تبلغ مليار دولاراً أمريكياً دايموند ديفيلوبرز ومجموعة عُمران تعلنان عن إطلاق المدينة المستدامة في يتي | المدينة المستدامة يتي",
          url: "https://thesustainablecity-yiti.com/ar/news/investment-value-news",
          description:
            "بقيمة استثمارية تبلغ مليار دولاراً أمريكياً دايموند ديفيلوبرز ومجموعة عُمران تعلنان عن إطلاق المدينة المستدامة في يتي",
        },
        canonicaltag:
          "https://www.thesustainablecity-yiti.com/ar/news/investment-value-news",
      },
      "environment-clean-marinedebris": {
        title:
          "المدينة المستدامة - يتي وجمعية البيئة العمانية تتعاونان للتخلص من أكثر من ١.٥ طن من المخلفات في شواطئ مسقط | المدينة المستدامة يتي",
        description:
          "المدينة المستدامة - يتي وجمعية البيئة العمانية تتعاونان للتخلص من أكثر من ١.٥ طن من المخلفات في شواطئ مسقط",
        keyword: [
          "يتي",
          "المدينة المستدامة",
          "مسقط",
        ...
        og: {
          ...
          title:
            "المدينة المستدامة - يتي وجمعية البيئة العمانية تتعاونان للتخلص من أكثر من ١.٥ طن من المخلفات في شواطئ مسقط | المدينة المستدامة يتي",
          url: "https://thesustainablecity-yiti.com/ar/news/environment-clean-marinedebris",
          description:
            "المدينة المستدامة - يتي وجمعية البيئة العمانية تتعاونان للتخلص من أكثر من ١.٥ طن من المخلفات في شواطئ مسقط",
        },
        canonicaltag:
          "https://www.thesustainablecity-yiti.com/ar/news/environment-clean-marinedebris",
      },
    },
  },
};
